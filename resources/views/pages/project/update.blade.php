                ...
                <form class="row col-12" action="{{ route('projects.update', ['id' => $project->id]) }}" method="POST">
                    ...
                    <div class="form-group col-4 {{ $errors->first('created_by') ? ' has-error' : '' }}">
                        ...
                        <select class="form-control" name="created_by" id="created_by">
                            @foreach ($users as $item)
                                <option
                                    {{ $project->created_by == $item->id || auth()->id() == $item->id ? 'selected' : '' }}
                    ...
                    <div id="creator-group"
                        ...
                        <select class="form-control" name="creator_id" id="creator_id">
                            @foreach ($users as $item)
                                <option
                                    {{ $project->creator_id == $item->id || auth()->id() == $item->id ? 'selected' : '' }}
                                    value="{{ $item->id }}">{{ $item->name }} ({{ $item->role->name }})</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-12">
                        ...
                        <div id="add-attachment-alone" class="text-primary cursor-pointer my-2 d-none btn"
                            data-bs-toggle="tooltip" title="Thêm tệp">
                                ...
                                <div class="col-4 d-flex flex-column mb-2 attachment-item py-2"
                                    ...
                                    <div class="col-md-12">
                                        <label class="upload-box w-100 text-center">
                                            ...
                                            <small
                                                class="file-name text-muted text-truncate d-block mt-1">{{ $attachment['file_path'] }}</small>
