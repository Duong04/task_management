@extends('layouts.master-layout', ['title' => 'Admin - Danh sách vai trò'])
                                            ...
                                            <div class="img-users d-flex justify-content-end position-relative">
                                                @can('general-check', ['Role Management', 'create'])
                                                    <a href="{{ route('roles.create') }}"
                                                        class="btn btn-primary btn-round ms-auto">Thêm vai trò</a>
                                                @endcan
                                            </div>
                                            <div class="img-users d-flex justify-content-end position-relative">
                                                ...
                                                <div class="pt-3">
                                                    ...
                                                    <div class="d-flex">
                                                        @can('general-check', ['Role Management', 'update'])
                                                            <a href="{{ route('roles.show', ['id' => $item->id]) }}"
                                                        ...
                                                        @can('general-check', ['Role Management', 'delete'])
                                                            <form id="delete-form-{{ $item->id }}" method="POST"
                                                                action="{{ route('roles.delete', ['id' => $item->id]) }}">
                                                                @csrf
                                                                @method('DELETE')
