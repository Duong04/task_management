                                ...
                                <div class="col-4 p-2">
                                    <div class="p-4 m-h-170 bg-white rounded-3 shadow d-flex justify-content-between">
                                        <div class="d-flex flex-column justify-content-between">
                                            <div>
                                                <img width="60px"
                                                    src="/assets/master/img/avatar/icon/pose_m1-qLsl3hEh.png"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div>
                                            <div class="img-users d-flex justify-content-end position-relative">
                                                @can('general-check', ['Position Management', 'create'])
                                                    <a href="{{ route('positions.create') }}"
                                                        class="btn btn-primary btn-round ms-auto">Thêm chức vụ</a>
                                                @endcan
                                            </div>
                                            <div class="img-users d-flex justify-content-end position-relative">
                                        ...
                                        <div class="p-4 m-h-170 bg-white rounded-3 shadow d-flex justify-content-between">
                                            <div class="d-flex flex-column justify-content-between">
                                                ...
                                                <div class="pt-3">
                                                    <h5>{{ $item->name }}</h5>
                                                    <div class="d-flex">
                                                        @can('general-check', ['Position Management', 'update'])
                                                        ...
                                                        @endcan
                                                        @can('general-check', ['Position Management', 'delete'])
                                                            <form id="delete-form-{{ $item->id }}" method="POST"
                                                                action="{{ route('positions.delete', ['id' => $item->id]) }}">
                                                                @csrf
                                                                @method('DELETE')
                                                ...
                                                <div class="img-users d-flex position-relative">
                                                    <div class="img-user">
                                                        <img class="h-100 w-100 rounded-circle"
                                                            src="/assets/master/img/avatar/icon/avatar-1-sTigs3cJ.png"
                                                            alt="">
                                                    </div>
                                                    <div class="img-user">
                                                        <img class="h-100 w-100 rounded-circle"
                                                            src="/assets/master/img/avatar/icon/avatar-2-wiQeFG56.png"
                                                            alt="">
                                                    </div>
                                                    <div class="img-user">
                                                        <img class="h-100 w-100 rounded-circle"
                                                            src="/assets/master/img/avatar/icon/avatar-3-wR29q9GN.png"
                                                            alt="">
                                                    </div>
                                                    <div class="img-user">
                                                        <div
